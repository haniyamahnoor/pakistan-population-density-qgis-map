...
Both datasets were prepared to ensure a common join field (district/province name or code).
...
Applied a graduated colour symbology (light to dark) to represent low to high density.
